      ...
      <div ref={modalRef} className="modal">
        ...
        <div className="modal-content">
          ...
          >
            ...
            {}
            <p style={{ marginBottom: "8px" }} className="blue-title">
              <b style={{ color: "#0043ce" }}>Problem Statement:</b>{" "}
              <b>{ps.title}</b>
            </p>
            <p style={{ marginBottom: "8px" }} className="blue-title">
              <b style={{ color: "#0043ce" }}>Key:</b> <b>{ps.key}</b>
            </p>
            <p style={{ marginBottom: "8px" }} className="mb-4 blue-title">
              <b style={{ color: "#0043ce" }}>Organisation:</b>{" "}
              <b>{ps.organisation}</b>
            </p>
            <span style={{ textAlign: "justify" }} className="mb-4">
              <p className="description">{ps.Statement}</p>
            </span>
          </section>
        </div>
      </div>

      <Heading text="Problem Statements" position="center" />
