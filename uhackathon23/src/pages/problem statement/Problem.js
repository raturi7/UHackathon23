...
const Problem = () => {
  ...
  function printData() {
    ...
    for (i = 0; i < keys.length; i++) {
      const htmlString = `<p style="marginBottom: 8px;" className="blue-title"><b style="color: #0043ce;">${keys[i]}:</b> <b>${values[i]}</b></p>`;
    ...
    return (
      <div className="col-4 card-container">
        ...
        >
          ...
          <div className="card-content d-flex flex-column align-items-start justify-content-center title-ps"  > 
            <h5
              style={{ fontWeight: "600", color: "#2E2545", textAlign: "left",maxHeight:"40px"}} 
            >
              {data.Title}
            </h5>
