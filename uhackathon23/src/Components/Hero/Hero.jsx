      ...
      <div className="container content-text">
        <div className="d-flex flex-column align-items-start justify-content-center">
          ...
          <h5 style={{ letterSpacing: "0.1rem", lineHeight: "30px" }}>
            The 4th iteration of UPES Hackathon,
            <br /> UHackathon 4.0 META welcomes you!
          </h5>
          <button className="btn  mt-4 rounded  !bg-orange-600 register-btn !hover:bg-white	">Register Now</button>
        </div>
